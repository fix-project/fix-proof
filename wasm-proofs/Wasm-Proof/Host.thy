...
lemma fixpoint_is_equal_correct_handle_neq:
  "\<not>is_equal h1 h2 \<longleftrightarrow> host_func_apply_impl s type0 fixpoint_is_equal 
  [(V_ref (ConstRefExtern (to_externref h1))), (V_ref (ConstRefExtern (to_externref h2)))] = Some(s, [V_num (ConstInt32 (I32.int_of_nat 0))])"
  using fixpoint_is_equal_impl bool_to_i32_false by auto
...
lemma fixpoint_is_equal_correct_externref_neq:
  ...
  using fixpoint_is_equal_correct_handle_neq fixpoint_is_equal_impl by auto
end