...
lemma mb_some:
  assumes "make_storage_coupon_raw coupons l r = Some res"
...
proof -
  ...
  by (metis assms is_coupon_lhs is_coupon_rhs is_storage_coupon_api_def make_storage_coupon_raw.elims option.simps(3))

  then have "make_storage_coupon_raw coupons l r = 
...
lemma make_storage_coupon_raw_run_iter:
  assumes "make_storage_coupon_raw coupons l r = Some res"
  shows  "run_iter (n + 33)
          (Config 
           (Suc n')
           ...
           (Frame_context 
              (Redex ((V_ref (ConstRefExtern (to_externref r))) #
                      ...
                      rest_vs)
                     [Invoke func_make_storage_coupon_idx]
                     b_es)
...
proof -
  have plus_33:
"n + 33 = (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc (Suc n)))))))))))))))))))))))))))))))))"
  by auto
  ...
  have C: "\<And>s. (host_func_apply_impl s type_r_i32    fixpoint_is_storage_coupon 
    [V_ref (ConstRefExtern (to_externref c))] = Some (s, [V_num (ConstInt32 (I32.int_of_nat 1))]))"
    using fixpoint_is_storage_coupon_externref 2 by auto
  ...
  show ?thesis
    ...
    by (simp del: split_n.simps add: init_def func_make_storage_coupon_idx_def n_zeros_def bitzero_def tab_coupons_idx_def app_s_f_v_s_table_get_def stab_ind_def load_tabs1_def B
    app_f_v_s_local_set_def app_f_v_s_local_get_def app_f_call_def sfunc_ind_def typeof_def typeof_num_def  se tb_tf_def typeof_ref_def app_v_s_binop_def app_binop_def app_binop_i_v_def app_binop_i_def D split_n_0 split_n_1 split_n_2 app_v_s_if_def plus_33)
qed
...
lemma mb_some_rev:
  assumes "(\<exists>c xs l' r'. coupons = c # xs
              ...
              \<and> is_equal r r'
              \<and> res = (create_eq_coupon l r))"
  shows "make_storage_coupon_raw coupons l r = Some res"
  using assms by fastforce

lemma mb_none:
  assumes "make_storage_coupon_raw coupons l r = None"
  shows "(coupons = [] \<or>
          ...
          (\<exists> c xs l' r'. coupons = c # xs \<and>
                         ...
                         is_equal l l' \<and>
                         \<not> is_equal r r'))"
  by (metis assms if_Some_None_eq_None is_coupon_lhs is_coupon_rhs is_storage_coupon_api_def make_storage_coupon_raw.elims mb_some_rev)

lemma make_storage_coupon_raw_run_invoke_none:
  assumes "make_storage_coupon_raw coupons l r = None"
...
proof -
  ...
  proof
    ...
    show ?thesis
      using 1
      by (auto split: cl.splits simp del: split_n.simps simp add: init_def func_make_storage_coupon_idx_def app_f_call_def sfunc_ind_def n_zeros_def bitzero_def split_n_2 tab_coupons_idx_def app_s_f_v_s_table_get_def stab_ind_def load_tabs1_def)
  next
    assume "?B \<or> ?C \<or> ?D"
    then show "?thesis"
    proof
      ...
      then show "?thesis"        
        using fixpoint_is_storage_coupon_externref_neq[of "to_externref c" ?state] 2
        by (auto split: cl.splits simp del: split_n.simps simp add: init_def func_make_storage_coupon_idx_def n_zeros_def bitzero_def tab_coupons_idx_def app_s_f_v_s_table_get_def stab_ind_def load_tabs1_def app_f_v_s_local_set_def app_f_v_s_local_get_def app_f_call_def sfunc_ind_def typeof_def typeof_num_def  se tb_tf_def typeof_ref_def app_v_s_binop_def app_binop_def app_binop_i_v_def app_binop_i_def 1 nat_of_int_i32.abs_eq sf split_n_0 split_n_1 split_n_2 app_v_s_if_def)
    next
      assume "?C \<or> ?D"
      then show "?thesis"
      proof
        ...
        show "?thesis" 
          using fixpoint_is_storage_coupon_externref[of "to_externref c" ?state] 2
          ...
          apply (auto split: cl.splits simp add: init_def func_make_storage_coupon_idx_def n_zeros_def bitzero_def tab_coupons_idx_def app_s_f_v_s_table_get_def stab_ind_def load_tabs1_def app_f_v_s_local_set_def app_f_v_s_local_get_def app_f_call_def sfunc_ind_def typeof_def typeof_num_def app_v_s_if_def se tb_tf_def typeof_ref_def app_v_s_binop_def app_binop_def app_binop_i_v_def app_binop_i_def 1 nat_of_int_i32.abs_eq sf split_n_0 split_n_1 split_n_2)
          done
      next
        assume ?D
        then obtain c xs l' r' where 1: "coupons = c # xs"
        ...
        show "?thesis"
          ...
          by (auto split: cl.splits simp add: init_def func_make_storage_coupon_idx_def n_zeros_def bitzero_def tab_coupons_idx_def app_s_f_v_s_table_get_def stab_ind_def load_tabs1_def app_f_v_s_local_set_def app_f_v_s_local_get_def app_f_call_def sfunc_ind_def typeof_def typeof_num_def app_v_s_if_def se tb_tf_def typeof_ref_def app_v_s_binop_def app_binop_def app_binop_i_v_def app_binop_i_def 1 nat_of_int_i32.abs_eq sf 7 split_n_0 split_n_1 split_n_2)
      qed
    qed
  qed
qed
